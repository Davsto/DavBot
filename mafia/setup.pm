...
#	},
	...
	pokemon => {
		...
		help => "Pokémon: A theme setup based on Pokémon. Made by Davsto.",
		minplayersrandom => 4,
		randomok => 1,
		theme => "poke",
	},
	wackypokemon => {
		...
		basic => 1,
		weirdness => 0.9,
		help => "Wacky Pokémon: The Pokémon theme setup, but with a considerably larger number of unusual roles.",
		randomok => 1,
		minplayersrandom => 4,
		realok => 1,
		theme => "poke",
	...
	insanepokemon => {
		...
		weirdness => 1,
		nolimits => 1,
		help => "Insane Pokémon: The Pokémon theme, but with even more insane roles, even useless ones.",
		randomok=> 1,
		minplayersrandom => 4,
		realok => 1,
		theme => "poke",
